    ...
    <section className='flex flex-col space-y-8 pt-10'>
      ...
      <div className='bg-light-page-background dark:bg-dark-page-background text-light-text-300 dark:text-dark-text-300 rounded-t-lg py-1 relative z-10'>
        <div className='flex items-center px-4'>
          ...
          <input type="text" name='search' value={search} onChange={handleChange} placeholder='search for location' className='py-2 px-2 w-full focus:outline-none bg-transparent font-mono text-lg placeholder:text-light-text-400'/>
        </div>
        <div className='space-y-4 absolute w-full bg-light-page-background dark:bg-dark-page-background rounded-b-lg backdrop-blur-xl'>
          {
